...
export const CHARACTER_PRESETS: CharacterPreset[] = [
  {
    id: 'man-business',
    label: 'Business Man',
    preview: '/assets/presets/characters/man-business.svg',
    promptModifier: 'professional businessman in a suit, confident pose',
    type: 'preset',
  },
  {
    id: 'woman-casual',
    label: 'Casual Woman',
    preview: '/assets/presets/characters/woman-casual.svg',
    promptModifier: 'young woman in casual clothing, relaxed expression',
    type: 'preset',
  },
  {
    id: 'woman-elegant',
    label: 'Elegant Woman',
    preview: '/assets/presets/characters/woman-elegant.svg',
    promptModifier: 'elegant woman in formal attire, sophisticated look',
    type: 'preset',
  },
  {
    id: 'man-creative',
    label: 'Creative Man',
    preview: '/assets/presets/characters/man-creative.svg',
    promptModifier: 'creative artist man, modern style, expressive',
    type: 'preset',
  },
  {
    id: 'child-playful',
    label: 'Playful Child',
    preview: '/assets/presets/characters/child-playful.svg',
    promptModifier: 'cheerful child, playful expression, innocent',
    type: 'preset',
  },
  {
    id: 'elderly-wise',
    label: 'Wise Elder',
    preview: '/assets/presets/characters/elderly-wise.svg',
    promptModifier: 'wise elderly person, distinguished appearance, warm smile',
    type: 'preset',
  },
  {
    id: 'athlete',
    label: 'Athlete',
    preview: '/assets/presets/characters/athlete.svg',
    promptModifier: 'athletic person, fit physique, sporty attire',
    type: 'preset',
  },
  {
    id: 'scientist',
    label: 'Scientist',
    preview: '/assets/presets/characters/scientist.svg',
    promptModifier: 'scientist in lab coat, intellectual appearance',
    type: 'preset',
  },
];
